...
int spa_fourth_set_champion(BYTE* _this) {
	...
	DWORD comp_ids[5] = { SPA_FOURTH_G1_9CF(), SPA_FOURTH_G2_9CF(), SPA_FOURTH_G3_9CF(), SPA_FOURTH_G4_9CF(), SPA_FOURTH_G5_9CF() };
...
DWORD spa_fourth_fixtures(BYTE* _this, char stage_idx, WORD* num_rounds, WORD* stage_name_id, DWORD* a5)
{
	if (stage_idx < 4) {
		...
		*stage_name_id = PromotionPlayoff;
		...
		FillFixtureDetails(pMem, fixture_id++, Final, 0, NoTiebreak_1, ExtraTimePenaltiesNoAwayGoals_2, 6, 10, 5, 0, 0, 0, 2, 7);
