...
void __declspec(naked) cro_super_free_c()		// used as a __thiscall -> __cdecl converter
{
	__asm
	{
		mov eax, esp
...
void __declspec(naked) cro_super_fixture_caller()		// used as a __thiscall -> __cdecl converter
{
	__asm
	{
		mov eax, esp
...
void __declspec(naked) cro_super_update_c()		// used as a __thiscall -> __cdecl converter
{
	__asm
	{
		mov eax, esp
