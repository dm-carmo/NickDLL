...
void african_nations_all_teams(BYTE* _this) {
	...
	WORD year = data->year;
	teams_seeded* teamList = (teams_seeded*)data->special_teams_seedings;
	BYTE* pMem = (BYTE*)cm0102_malloc(24 * 5);
	if (year == 2025) {
		WORD x = 0;
		*((DWORD*)(pMem + 5 * (x++))) = get_national_team(NATION_MOROCCO_9CF())->ClubID;
		*((DWORD*)(pMem + 5 * (x++))) = get_national_team(NATION_MALI_9CF())->ClubID;
		*((DWORD*)(pMem + 5 * (x++))) = get_national_team(NATION_COMOROS_9CF())->ClubID;
		*((DWORD*)(pMem + 5 * (x++))) = get_national_team(NATION_ZAMBIA_9CF())->ClubID;
		*((DWORD*)(pMem + 5 * (x++))) = get_national_team(NATION_EGYPT_9CF())->ClubID;
		*((DWORD*)(pMem + 5 * (x++))) = get_national_team(NATION_SOUTH_AFRICA_9CF())->ClubID;
		*((DWORD*)(pMem + 5 * (x++))) = get_national_team(NATION_ANGOLA_9CF())->ClubID;
		*((DWORD*)(pMem + 5 * (x++))) = get_national_team(NATION_ZIMBABWE_9CF())->ClubID;
		*((DWORD*)(pMem + 5 * (x++))) = get_national_team(NATION_NIGERIA_9CF())->ClubID;
		*((DWORD*)(pMem + 5 * (x++))) = get_national_team(NATION_TUNISIA_9CF())->ClubID;
		*((DWORD*)(pMem + 5 * (x++))) = get_national_team(NATION_TANZANIA_9CF())->ClubID;
		*((DWORD*)(pMem + 5 * (x++))) = get_national_team(NATION_UGANDA_9CF())->ClubID;
		*((DWORD*)(pMem + 5 * (x++))) = get_national_team(NATION_SENEGAL_9CF())->ClubID;
		*((DWORD*)(pMem + 5 * (x++))) = get_national_team(NATION_DR_CONGO_9CF())->ClubID;
		*((DWORD*)(pMem + 5 * (x++))) = get_national_team(NATION_BENIN_9CF())->ClubID;
		*((DWORD*)(pMem + 5 * (x++))) = get_national_team(NATION_BOTSWANA_9CF())->ClubID;
		*((DWORD*)(pMem + 5 * (x++))) = get_national_team(NATION_ALGERIA_9CF())->ClubID;
		*((DWORD*)(pMem + 5 * (x++))) = get_national_team(NATION_BURKINA_FASO_9CF())->ClubID;
		*((DWORD*)(pMem + 5 * (x++))) = get_national_team(NATION_SUDAN_9CF())->ClubID;
		*((DWORD*)(pMem + 5 * (x++))) = get_national_team(NATION_EQUATORIAL_GUINEA_9CF())->ClubID;
		...
		*((DWORD*)(pMem + 5 * (x++))) = get_national_team(NATION_MOZAMBIQUE_9CF())->ClubID;
		*((DWORD*)(pMem + 5 * (x++))) = get_national_team(NATION_GABON_9CF())->ClubID;
