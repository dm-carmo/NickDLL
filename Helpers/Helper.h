...
vector<cm3_clubs*> find_clubs_of_comp(DWORD comp_id, DWORD nation_id = -1);
vector<cm3_clubs*> find_clubs_of_comp_reserve_division(DWORD comp_id, DWORD nation_id = -1);
vector<cm3_clubs*> find_clubs_of_comp_main_reserve_division(DWORD main_comp_id, DWORD reserve_comp_id, DWORD nation_id = -1);
vector<cm3_clubs*> find_clubs_of_comp_last_division(DWORD comp_id, DWORD nation_id = -1);
...
WORD CountNumberOfTeamsInComp(DWORD CompID, DWORD nation_id = -1);
WORD CountNumberOfTeamsInReserveComp(DWORD CompID, DWORD nation_id = -1);
WORD CountNumberOfTeamsInCompNoReserve(DWORD CompID, DWORD nation_id = -1);
WORD CountNumberOfTeamsInCompWithGroup(DWORD CompID, DWORD GroupID, DWORD nation_id = -1);
