...
void __declspec(naked) wal_first_s_free_c()
{
	__asm
	{
		mov eax, esp
...
void __declspec(naked) wal_first_s_fixtures_c()
{
	__asm
	{
		mov eax, esp
...
void __declspec(naked) wal_first_s_update_c()
{
	__asm
	{
		mov eax, esp
...
void __declspec(naked) wal_first_s_subs_c()
{
	__asm
	{
		mov eax, esp
