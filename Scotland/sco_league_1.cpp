...
void __declspec(naked) sco_league_1_table_fates_c()
{
	__asm
	{
		mov eax, esp
...
void setup_sco_league_1()
{
	...
	WriteVTablePtr(sco_league_1_vtable, VTableTableFates, (DWORD)&sco_league_1_table_fates_c);
