...
void __declspec(naked) sco_challenge_cup_free_c()		// used as a __thiscall -> __cdecl converter
{
	__asm
	{
		mov eax, esp
...
void __declspec(naked) sco_challenge_cup_set_champion_c()		// used as a __thiscall -> __cdecl converter
{
	__asm
	{
		mov eax, esp
...
void __declspec(naked) sco_challenge_cup_subs_c()		// used as a __thiscall -> __cdecl converter
{
	__asm
	{
		mov eax, esp
...
void __declspec(naked) sco_challenge_cup_fixture_caller()		// used as a __thiscall -> __cdecl converter
{
	__asm
	{
		mov eax, esp
...
void __declspec(naked) sco_challenge_cup_reputation_setup_c()		// used as a __thiscall -> __cdecl converter
{
	__asm
	{
		mov eax, esp
...
void __declspec(naked) sco_challenge_cup_reputation_calc_c()		// used as a __thiscall -> __cdecl converter
{
	__asm
	{
		mov eax, esp
...
void __declspec(naked) sco_challenge_cup_update_c()		// used as a __thiscall -> __cdecl converter
{
	__asm
	{
		mov eax, esp
...
void __declspec(naked) sco_challenge_cup_set_table_fate()		// used as a __thiscall -> __cdecl converter
{
	__asm
	{
		mov eax, esp
...
void __declspec(naked) sco_challenge_cup_stages_create_c()		// used as a __thiscall -> __cdecl converter
{
	__asm
	{
		mov eax, esp
...
void sco_challenge_cup_init(BYTE* _this, WORD year, cm3_club_comps* comp) {
	...
	sco_challenge_cup_vtable->SetPointer(VTableStageNews, 0x48C6D0);
	...
	sco_challenge_cup_vtable->SetPointer(VTableLeagueSplit, (DWORD)0x6847c0);
	data->rules = 0x19;
	data->f81 = 0xc;
