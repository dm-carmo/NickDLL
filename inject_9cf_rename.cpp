...
BYTE* check_if_reserve_team_new(cm3_clubs* to_check, DWORD* is_main_club, DWORD a3) {
	...
	if (to_check->ClubNation->NationID == NATION_GERMANY_9CF()) {
		...
		if (_strcmpi(db_club_name, "FC Carl Zeiss Jena") == 0) { cm3_clubs* ret = find_club("FC Carl Zeiss Jena II"); if (ret) return (BYTE*)ret; }
		...
		if (_strcmpi(db_club_name, "1.FC Magdeburg") == 0) { cm3_clubs* ret = find_club("1.FC Magdeburg II"); if (ret) return (BYTE*)ret; }
		...
		if (_strcmpi(db_club_name, "Rot-Weiß Oberhausen") == 0) { cm3_clubs* ret = find_club("RW Oberhausen Amateure"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "SSV Ulm 1846") == 0) { cm3_clubs* ret = find_club("SSV Ulm 1846 II"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "SG Wattenscheid 09") == 0) { cm3_clubs* ret = find_club("SG Wattenscheid 09 II"); if (ret) return (BYTE*)ret; }
	}
		...
		if (_strcmpi(db_club_name, "U.D. Salamanca") == 0) { cm3_clubs* ret = find_club("U.D. Salamanca B"); if (ret) return (BYTE*)ret; }
	}
		...
		if (_strcmpi(db_club_name, "CD Santa Clara") == 0) { cm3_clubs* ret = find_club("CD Santa Clara B"); if (ret) return (BYTE*)ret; }
	}
		...
		if (_strcmpi(db_club_name, "Åsane Fotball") == 0) { cm3_clubs* ret = find_club("Åsane Fotball II"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Bærum SK") == 0) { cm3_clubs* ret = find_club("Bærum SK II"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "FK Bodø/Glimt") == 0) { cm3_clubs* ret = find_club("FK Bodø/Glimt II"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "SK Brann") == 0) { cm3_clubs* ret = find_club("SK Brann II"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Bryne FK") == 0) { cm3_clubs* ret = find_club("Bryne FK II"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Byåsen TF") == 0) { cm3_clubs* ret = find_club("Byåsen IL II"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Follo FK") == 0) { cm3_clubs* ret = find_club("Follo FK II"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Fredrikstad FK") == 0) { cm3_clubs* ret = find_club("Fredrikstad FK II"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "FK Fyllingsdalen") == 0) { cm3_clubs* ret = find_club("FK Fyllingsdalen II"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "SK Gjøvik-Lyn") == 0) { cm3_clubs* ret = find_club("FK Gjøvik-Lyn II"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Grorud IL") == 0) { cm3_clubs* ret = find_club("Grorud IL II"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Hamarkameratene") == 0) { cm3_clubs* ret = find_club("Hamarkameratene II"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "FK Haugesund") == 0) { cm3_clubs* ret = find_club("FK Haugesund II"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "IL Hødd") == 0) { cm3_clubs* ret = find_club("IL Hødd II"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Hønefoss BK") == 0) { cm3_clubs* ret = find_club("Hønefoss BK II"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "KFUM-Kameratene Oslo") == 0) { cm3_clubs* ret = find_club("KFUM-Kameratene Oslo II"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Kjelsås IL") == 0) { cm3_clubs* ret = find_club("Kjelsas IL II"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Kongsvinger IL") == 0) { cm3_clubs* ret = find_club("Kongsvinger IL II"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Kristiansund BK") == 0) { cm3_clubs* ret = find_club("Kristiansund BK II"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Lillestrøm SK") == 0) { cm3_clubs* ret = find_club("Lillestrøm SK II"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Lyn 1896 FK") == 0) { cm3_clubs* ret = find_club("Lyn 1896 FK II"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Mjøndalen IF") == 0) { cm3_clubs* ret = find_club("Mjøndalen IF II"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Molde FK") == 0) { cm3_clubs* ret = find_club("Molde FK II"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Nardo FK") == 0) { cm3_clubs* ret = find_club("Nardo FK II"); if (ret) return (BYTE*)ret; }
		...
		if (_strcmpi(db_club_name, "Ranheim IL") == 0) { cm3_clubs* ret = find_club("Ranheim IL II"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Raufoss IL") == 0) { cm3_clubs* ret = find_club("Raufoss IL II"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Rosenborg BK") == 0) { cm3_clubs* ret = find_club("Rosenborg BK II"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Sandefjord Fotball") == 0) { cm3_clubs* ret = find_club("Sandefjord Fotball II"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Sandnes Ulf") == 0) { cm3_clubs* ret = find_club("Sandnes Ulf II"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Sarpsborg 08 FF") == 0) { cm3_clubs* ret = find_club("Sarpsborg 08 FF II"); if (ret) return (BYTE*)ret; }
		...
		if (_strcmpi(db_club_name, "IK Start") == 0) { cm3_clubs* ret = find_club("IK Start II"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Strømmen IF") == 0) { cm3_clubs* ret = find_club("Strømmen IL II"); if (ret) return (BYTE*)ret; }
		...
		if (_strcmpi(db_club_name, "SK Træff") == 0) { cm3_clubs* ret = find_club("SK Træff II"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Ullensaker/Kisa IL") == 0) { cm3_clubs* ret = find_club("Ullensaker/Kisa IL II"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "SK Vard Haugesund") == 0) { cm3_clubs* ret = find_club("SK Vard Haugesund II"); if (ret) return (BYTE*)ret; }
		...
		if (_strcmpi(db_club_name, "Atlantis FC") == 0) { cm3_clubs* ret = find_club("Atlantis FC II"); if (ret) return (BYTE*)ret; }
		...
		if (_strcmpi(db_club_name, "FC Inter Turku") == 0) { cm3_clubs* ret = find_club("FC Inter Turku II"); if (ret) return (BYTE*)ret; }
		...
		if (_strcmpi(db_club_name, "Akron Tolyatti") == 0) { cm3_clubs* ret = find_club("Akron-2 Togliatti"); if (ret) return (BYTE*)ret; }
		...
		if (_strcmpi(db_club_name, "Dinamo Makhachkala") == 0) { cm3_clubs* ret = find_club("Dinamo Makhachkala II"); if (ret) return (BYTE*)ret; }
		...
		if (_strcmpi(db_club_name, "Kosmos Khimki") == 0) { cm3_clubs* ret = find_club("Kosmos-2 Dolgoprudnyi"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Krylya Sovetov Samara") == 0) { cm3_clubs* ret = find_club("Krylya Sovetov 2 Samara"); if (ret) return (BYTE*)ret; }
		...
		if (_strcmpi(db_club_name, "FC FC Zbrojovka Brno") == 0) { cm3_clubs* ret = find_club("FC FC Zbrojovka Brno B"); if (ret) return (BYTE*)ret; }
		...
		if (_strcmpi(db_club_name, "FK Pribram") == 0) { cm3_clubs* ret = find_club("FK Pribram B"); if (ret) return (BYTE*)ret; }
		...
		if (_strcmpi(db_club_name, "Grasshopper Club Zurich") == 0) { cm3_clubs* ret = find_club("Grasshopper Club Zürich U21"); if (ret) return (BYTE*)ret; }
		...
		if (_strcmpi(db_club_name, "FC Sion") == 0) { cm3_clubs* ret = find_club("FC Sion U21"); if (ret) return (BYTE*)ret; }
		...
		if (_strcmpi(db_club_name, "Le Mans FC") == 0) { cm3_clubs* ret = find_club("Le Mans FC B"); if (ret) return (BYTE*)ret; }
		...
		if (_strcmpi(db_club_name, "Vendée Les Herbiers Football") == 0) { cm3_clubs* ret = find_club("Vendée Les Herbiers Football B"); if (ret) return (BYTE*)ret; }
		...
		if (_strcmpi(db_club_name, "US Boulogne") == 0) { cm3_clubs* ret = find_club("US Boulogne B"); if (ret) return (BYTE*)ret; }
	...
	if (to_check->ClubNation->NationID == NATION_GERMANY_9CF()) {
		...
		if (_strcmpi(db_club_name, "FC Carl Zeiss Jena II") == 0) { cm3_clubs* ret = find_club("FC Carl Zeiss Jena"); if (ret) return (BYTE*)ret; }
		...
		if (_strcmpi(db_club_name, "1.FC Magdeburg II") == 0) { cm3_clubs* ret = find_club("1.FC Magdeburg"); if (ret) return (BYTE*)ret; }
		...
		if (_strcmpi(db_club_name, "RW Oberhausen Amateure") == 0) { cm3_clubs* ret = find_club("Rot-Weiß Oberhausen"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "SSV Ulm 1846 II") == 0) { cm3_clubs* ret = find_club("SSV Ulm 1846"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "SG Wattenscheid 09 II") == 0) { cm3_clubs* ret = find_club("SG Wattenscheid 09"); if (ret) return (BYTE*)ret; }
	}
	else if (to_check->ClubNation->NationID == NATION_SPAIN_9CF()) {
		...
		if (_strcmpi(db_club_name, "U.D. Salamanca B") == 0) { cm3_clubs* ret = find_club("U.D. Salamanca"); if (ret) return (BYTE*)ret; }
	}
	else if (to_check->ClubNation->NationID == NATION_PORTUGAL_9CF()) {
		...
		if (_strcmpi(db_club_name, "CD Santa Clara B") == 0) { cm3_clubs* ret = find_club("CD Santa Clara"); if (ret) return (BYTE*)ret; }
	}
	else if (to_check->ClubNation->NationID == NATION_NORWAY_9CF()) {
		if (_strcmpi(db_club_name, "Aalesunds FK II") == 0) { cm3_clubs* ret = find_club("Aalesunds FK"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Åsane Fotball II") == 0) { cm3_clubs* ret = find_club("Åsane Fotball"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Bærum SK II") == 0) { cm3_clubs* ret = find_club("Bærum SK"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "FK Bodø/Glimt II") == 0) { cm3_clubs* ret = find_club("FK Bodø/Glimt"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "SK Brann II") == 0) { cm3_clubs* ret = find_club("SK Brann"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Bryne FK II") == 0) { cm3_clubs* ret = find_club("Bryne FK"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Byåsen IL II") == 0) { cm3_clubs* ret = find_club("Byåsen TF"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Follo FK II") == 0) { cm3_clubs* ret = find_club("Follo FK"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Fredrikstad FK II") == 0) { cm3_clubs* ret = find_club("Fredrikstad FK"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "FK Fyllingsdalen II") == 0) { cm3_clubs* ret = find_club("FK Fyllingsdalen"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "FK Gjøvik-Lyn II") == 0) { cm3_clubs* ret = find_club("SK Gjøvik-Lyn"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Grorud IL II") == 0) { cm3_clubs* ret = find_club("Grorud IL"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Hamarkameratene II") == 0) { cm3_clubs* ret = find_club("Hamarkameratene"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "FK Haugesund II") == 0) { cm3_clubs* ret = find_club("FK Haugesund"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "IL Hødd II") == 0) { cm3_clubs* ret = find_club("IL Hødd"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Hønefoss BK II") == 0) { cm3_clubs* ret = find_club("Hønefoss BK"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "KFUM-Kameratene Oslo II") == 0) { cm3_clubs* ret = find_club("KFUM-Kameratene Oslo"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Kjelsas IL II") == 0) { cm3_clubs* ret = find_club("Kjelsås IL"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Kongsvinger IL II") == 0) { cm3_clubs* ret = find_club("Kongsvinger IL"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Kristiansund BK II") == 0) { cm3_clubs* ret = find_club("Kristiansund BK"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Lillestrøm SK II") == 0) { cm3_clubs* ret = find_club("Lillestrøm SK"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Lyn 1896 FK II") == 0) { cm3_clubs* ret = find_club("Lyn 1896 FK"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Mjøndalen IF II") == 0) { cm3_clubs* ret = find_club("Mjøndalen IF"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Molde FK II") == 0) { cm3_clubs* ret = find_club("Molde FK"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Nardo FK II") == 0) { cm3_clubs* ret = find_club("Nardo FK"); if (ret) return (BYTE*)ret; }
		...
		if (_strcmpi(db_club_name, "Ranheim IL II") == 0) { cm3_clubs* ret = find_club("Ranheim IL"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Raufoss IL II") == 0) { cm3_clubs* ret = find_club("Raufoss IL"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Rosenborg BK II") == 0) { cm3_clubs* ret = find_club("Rosenborg BK"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Sandefjord Fotball II") == 0) { cm3_clubs* ret = find_club("Sandefjord Fotball"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Sandnes Ulf II") == 0) { cm3_clubs* ret = find_club("Sandnes Ulf"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Sarpsborg 08 FF II") == 0) { cm3_clubs* ret = find_club("Sarpsborg 08 FF"); if (ret) return (BYTE*)ret; }
		...
		if (_strcmpi(db_club_name, "IK Start II") == 0) { cm3_clubs* ret = find_club("IK Start"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Strømmen IL II") == 0) { cm3_clubs* ret = find_club("Strømmen IF"); if (ret) return (BYTE*)ret; }
		...
		if (_strcmpi(db_club_name, "SK Træff II") == 0) { cm3_clubs* ret = find_club("SK Træff"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Ullensaker/Kisa IL II") == 0) { cm3_clubs* ret = find_club("Ullensaker/Kisa IL"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "SK Vard Haugesund II") == 0) { cm3_clubs* ret = find_club("SK Vard Haugesund"); if (ret) return (BYTE*)ret; }
		...
		if (_strcmpi(db_club_name, "Atlantis FC II") == 0) { cm3_clubs* ret = find_club("Atlantis FC"); if (ret) return (BYTE*)ret; }
		...
		if (_strcmpi(db_club_name, "FC Inter Turku II") == 0) { cm3_clubs* ret = find_club("FC Inter Turku"); if (ret) return (BYTE*)ret; }
		...
		if (_strcmpi(db_club_name, "Akron-2 Togliatti") == 0) { cm3_clubs* ret = find_club("Akron Tolyatti"); if (ret) return (BYTE*)ret; }
		...
		if (_strcmpi(db_club_name, "Dinamo Makhachkala II") == 0) { cm3_clubs* ret = find_club("Dinamo Makhachkala"); if (ret) return (BYTE*)ret; }
		...
		if (_strcmpi(db_club_name, "Kosmos-2 Dolgoprudnyi") == 0) { cm3_clubs* ret = find_club("Kosmos Khimki"); if (ret) return (BYTE*)ret; }
		if (_strcmpi(db_club_name, "Krylya Sovetov 2 Samara") == 0) { cm3_clubs* ret = find_club("Krylya Sovetov Samara"); if (ret) return (BYTE*)ret; }
		...
		if (_strcmpi(db_club_name, "FC FC Zbrojovka Brno B") == 0) { cm3_clubs* ret = find_club("FC FC Zbrojovka Brno"); if (ret) return (BYTE*)ret; }
		...
		if (_strcmpi(db_club_name, "FK Pribram B") == 0) { cm3_clubs* ret = find_club("FK Pribram"); if (ret) return (BYTE*)ret; }
		...
		if (_strcmpi(db_club_name, "Grasshopper Club Zürich U21") == 0) { cm3_clubs* ret = find_club("Grasshopper Club Zurich"); if (ret) return (BYTE*)ret; }
		...
		if (_strcmpi(db_club_name, "FC Sion U21") == 0) { cm3_clubs* ret = find_club("FC Sion"); if (ret) return (BYTE*)ret; }
		...
		if (_strcmpi(db_club_name, "Le Mans FC B") == 0) { cm3_clubs* ret = find_club("Le Mans FC"); if (ret) return (BYTE*)ret; }
		...
		if (_strcmpi(db_club_name, "Vendée Les Herbiers Football B") == 0) { cm3_clubs* ret = find_club("Vendée Les Herbiers Football"); if (ret) return (BYTE*)ret; }
		...
		if (_strcmpi(db_club_name, "US Boulogne B") == 0) { cm3_clubs* ret = find_club("US Boulogne"); if (ret) return (BYTE*)ret; }
