...
void __declspec(naked) swe_first_free_c()
{
	__asm
	{
		mov eax, esp
...
void __declspec(naked) swe_first_subs_c()
{
	__asm
	{
		mov eax, esp
...
void __declspec(naked) swe_first_fixtures_c()
{
	__asm
	{
		mov eax, esp
...
void __declspec(naked) swe_first_playoffs_create()
{
	__asm
	{
		mov eax, esp
...
void __declspec(naked) swe_first_update_c()
{
	__asm
	{
		mov eax, esp
...
void __declspec(naked) swe_first_reputation_calc_c()
{
	__asm
	{
		mov eax, esp
...
int swe_first_stage_news(BYTE* _this, int club_idx, char fate, char stage_id, int stage_name_idx, int round_data, __int16 a7, int a8, char a9, int show_body_text, LPVOID* ret_str_ptr) {
	comp_stats* data = (comp_stats*)_this;
...
void __declspec(naked) swe_first_stage_news_c()
{
	__asm
	{
		mov eax, esp
