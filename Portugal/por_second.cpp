...
int por_second_table_indicators(BYTE* _this, cm3_clubs* club, BYTE fate, char stage, BYTE* a5, BYTE* round_data, int a7) {
...
void __declspec(naked) por_second_set_table_fate()
{
	__asm
	{
		mov eax, esp
