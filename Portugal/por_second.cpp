...
void __declspec(naked) por_second_free_c()
{
	__asm
	{
		mov eax, esp
...
void __declspec(naked) por_second_subs_c()
{
	__asm
	{
		mov eax, esp
...
void __declspec(naked) por_second_fixtures_c()
{
	__asm
	{
		mov eax, esp
...
void __declspec(naked) por_second_playoffs_create()
{
	__asm
	{
		mov eax, esp
...
int por_second_table_fates(BYTE* _this, cm3_clubs* club, BYTE fate, char stage, BYTE* a5, BYTE* round_data, int a7) {
...
void __declspec(naked) por_second_table_fates_c()
{
	__asm
	{
		mov eax, esp
...
void __declspec(naked) por_second_update_c()
{
	__asm
	{
		mov eax, esp
...
void __declspec(naked) por_second_reputation_calc_c()
{
	__asm
	{
		mov eax, esp
...
int por_second_stage_news(BYTE* _this, int club_idx, char fate, char stage_id, int stage_name_idx, int round_data, __int16 a7, int a8, char a9, int show_body_text, LPVOID* ret_str_ptr) {
	comp_stats* data = (comp_stats*)_this;
...
void __declspec(naked) por_second_stage_news_c()
{
	__asm
	{
		mov eax, esp
...
void setup_por_second()
{
	...
	WriteVTablePtr(por_second_vtable, VTableTableFates, (DWORD)&por_second_table_fates_c);
	WriteVTablePtr(por_second_vtable, VTableStageNews, (DWORD)&por_second_stage_news_c);
