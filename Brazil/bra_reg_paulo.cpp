...
int bra_reg_paulo_set_fates(BYTE* _this, cm3_clubs* club, char fate, char stage, BYTE* a5, BYTE* round_data, int a7) {
...
void __declspec(naked) bra_reg_paulo_set_table_fate()
{
	__asm
	{
		mov eax, esp
...
void setup_bra_reg_paulo() {
	...
	WriteVTablePtr(bra_reg_paulo_vtable, VTableTableFates, (DWORD)&bra_reg_paulo_set_table_fate);
