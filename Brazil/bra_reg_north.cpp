...
void __declspec(naked) bra_reg_north_set_champion_c()
{
	__asm
	{
		mov eax, esp
...
void __declspec(naked) bra_reg_north_reputation_calc_c()
{
	__asm
	{
		mov eax, esp
...
void __declspec(naked) bra_reg_north_subs_c()
{
	__asm
	{
		mov eax, esp
...
void __declspec(naked) bra_reg_north_fixtures_c()
{
	__asm
	{
		mov eax, esp
...
void __declspec(naked) bra_reg_north_update_c()
{
	__asm
	{
		mov eax, esp
...
void __declspec(naked) bra_reg_north_playoffs_create()
{
	__asm
	{
		mov eax, esp
...
void setup_bra_reg_north() {
	...
	WriteVTablePtr(bra_reg_north_vtable, VTableReputationSetup, 0x68a850);
